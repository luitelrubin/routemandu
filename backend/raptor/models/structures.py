...
@attrs.define(repr=False, eq=False, order=False)
class Stop:
    """Stop"""

    id = attrs.field(default=None)
    name = attrs.field(default=None)
    station: Station = attrs.field(default=None)
    platform_code = attrs.field(default=None)
    index = attrs.field(default=None)
...
class Stations:
    ...
    def add(self, station: Station):
        ...
        if station.id in self.set_idx:
            ...
            self.set_name_idx[station.name] = station
        return station
...
class TripStopTime:
    ...
    trip: Trip = attrs.field(default=attrs.NOTHING)
    stopidx = attrs.field(default=attrs.NOTHING)
    stop = attrs.field(default=attrs.NOTHING)
    dts_arr = attrs.field(default=attrs.NOTHING)
    dts_dep = attrs.field(default=attrs.NOTHING)
    fare = attrs.field(default=0.0)
...
class Trip:
    ...
    id = attrs.field(default=None)
    stop_times = attrs.field(default=attrs.Factory(list))
    stop_times_index = attrs.field(default=attrs.Factory(dict))
    hint = attrs.field(default=None)
    long_name = attrs.field(default=None)  # e.g., Sprinter
    gtfs_trip_id = attrs.field(default=None)  # multigtfs.models.Trip primary key
...
class Route:
    ...
    id = attrs.field(default=None)
    trips = attrs.field(default=attrs.Factory(list))
    stops = attrs.field(default=attrs.Factory(list))
...
class Transfer:
    ...
    id = attrs.field(default=None)
    from_stop = attrs.field(default=None)
    to_stop = attrs.field(default=None)
    layovertime = attrs.field(default=300)
...
class Leg:
    ...
    def to_dict(self, leg_index: int = None) -> Dict:
        ...
        return dict(
            ...
            gtfs_trip_id=self.trip.gtfs_trip_id,
