...
from raptor.dao.timetable_io import Timetable
from raptor.models.structures import Stop, Trip, Route, Leg, Journey
from raptor.util import LARGE_NUMBER, TRANSFER_TRIP
    ...
    def run(self, from_stops, dep_secs, rounds) -> Dict[int, Dict[Stop, Label]]:
        ...
        for k in range(1, rounds + 1):
            ...
            if len(marked_stops) > 0:
                ...
                for remaining_round in range(k, rounds + 1):
                    bag_round_stop[remaining_round] = deepcopy(bag_round_stop[k - 1])
                break
